...
// AUTOGENERIERT von sync_frontend.py aus frontend/app.js — NICHT direkt editieren.
// Frontend-Aenderungen in frontend/app.js machen und das Skript erneut laufen lassen.
const char APP_JS[] PROGMEM = R"rawjs(// Bomb Defusal — frontend logic. WebSocket client receives controller state
